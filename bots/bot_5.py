...
env_path = os.path.join(os.path.dirname(__file__), "bot_5.env")
...
async def callback_faq_1_handler(callback: CallbackQuery) -> None:
    try:
        await callback.message.answer("лох чилийский")
...
async def faq_handler(message: Message) -> None:
    ...
    keyboard_buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="как тя зовут", callback_data="faq_1"),
...
async def help_handler(message: Message) -> None:
    help_text = "*Для помощи напишите администратору:*\n👉 [@NeK0TeR 👈"
