...
env_path = os.path.join(os.path.dirname(__file__), "bot_4.env")
...
async def callback_faq_1_handler(callback: CallbackQuery) -> None:
    try:
        await callback.message.answer("asdfadfsadfsdf")
...
async def faq_handler(message: Message) -> None:
    ...
    keyboard_buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text="asdfadsf", callback_data="faq_1"),
